package com.example.springbootv2.utils;
...
public class Commons {
    ...
    public static String parsedate_zh_y_m(String date){
        if (StringUtils.isNotBlank(date)){
            Date d = DateUtils.dateFormat(date, "yyyy年MM月");
            return DateUtils.dateFormat(d, "yyyy");
        }
        return null;
    }
    ...
    public static Date fmtdate_date(String date){
        if (StringUtils.isNotBlank(date)){
            return DateUtils.dateFormat(date, "yyyy年MM月");
        }
        return null;
    }
    ...
    public static Date fmtdate_unxtime(Integer nuixTime){
        if (null != nuixTime){
            return DateUtils.getDateByUnixTime(nuixTime);
        }
        return  null;
    }
    /**
     ...
     * @return
     */
    public static String permalink(ContentMD contents) {
